      ...
      <div className='goal-three-page-wrapper'>
          <Header/>          
            <div className='goal-three-page-content'>
                <h2 style={{fontSize: '29px'}}>2027 Goal No. 3: Infrastructure</h2>        
            
                <div>The extent of infrastructure problems in Africa varies widely across the continent and can be assessed through various metrics, including access to electricity, roads, 
                    clean water, and internet connectivity. 
                <br />
        ...
        <div>
            <h2> South Sudan:</h2>
            South Sudan, the youngest country in Africa, faces substantial infrastructure challenges exacerbated by years of conflict and economic instability.
            The country has limited road networks, making transportation difficult, particularly during the rainy season when many roads become impassable.
            Access to electricity is extremely low, with less than 10% of the population having access to grid electricity. Many rely on traditional energy sources such as firewood and charcoal.
            Water and sanitation infrastructure in South Sudan is also insufficient, with only about 11% of the population having access to improved sanitation facilities.
            The percentage of infrastructure inadequacy in South Sudan is estimated to be around 60-70%.
        </div>

        <div>
        Overall, both the Democratic Republic of the Congo and South Sudan face significant infrastructure challenges, with limited access to essential services such as electricity, clean water, and 
        ...
        <div>        
            Poor infrastructure in countries like South Sudan and the Democratic Republic of Congo (DRC) severely impedes economic growth in several ways:
        <br />
        <h2></h2>
        ...
        community leaders, and technical professionals. By enhancing skills and knowledge in infrastructure planning, management, and maintenance, ADGI can strengthen local capacity to address infrastructure challenges effectively.

        

        <br />
        By employing these approaches, ADGI can contribute to addressing infrastructure challenges in Africa, ultimately fostering economic growth, improving living standards, and enhancing 
